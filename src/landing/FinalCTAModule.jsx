...
export function FinalCTAModule({ config, theme }) {
        ...
        >
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[1fr_320px] lg:items-center">
            <div>
              ...
              <h2 className="mt-5 max-w-3xl text-4xl font-black leading-tight tracking-[-0.03em] sm:text-5xl lg:text-6xl">
                Pronto para começar sua transformação?
              </h2>
              <p className="mt-6 max-w-2xl text-lg font-semibold leading-8 text-white/80">
                Agende uma avaliação com{' '}
                <strong>{professional.name || config.business.name}</strong> e tenha uma
                experiência conduzida com clareza, cuidado e presença profissional.
              </p>
              <a
                href="#agenda"
